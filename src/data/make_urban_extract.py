...
def main(boundaries_filepath, agglomeration_slug, lulc_filepath,
         output_filepath):
    logger = logging.getLogger(__name__)
    logger.info(f'preparing urban extracts for {lulc_filepath} and '
    ...
    with rio.open(lulc_filepath) as src:
        ...
        with rio.open(output_filepath, 'w', **kwds) as dst:
            dst.write(urban_arr.astype(dst_dtype), 1)
